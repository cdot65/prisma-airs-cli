...
- 805f07d: Fix `airs runtime customer-apps consumption` returning zero results when an integration overrides `metadata.app_name` in scan payloads (e.g. LiteLLM's `panw_prisma_airs` guardrail).
