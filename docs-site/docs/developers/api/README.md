...
- [RedTeamReportTable](interfaces/RedTeamReportTable.md)
...
- [ReportDailyTelemetry](interfaces/ReportDailyTelemetry.md)
...
- [ReportSessionSummary](interfaces/ReportSessionSummary.md)
- [ReportSeverity](interfaces/ReportSeverity.md)
