...
airs-cli model-security install --extras gcp --dir my-scanner
...
Get the raw authentication URL for Google Artifact Registry. For a fully automated setup, use `airs-cli model-security install` instead:
