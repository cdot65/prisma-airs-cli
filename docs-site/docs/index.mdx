...
<img src={useBaseUrl('/img/logo-wordmark-dark.svg')} alt="prisma-airs-cli" width="440" style={{maxWidth: '100%', height: 'auto'}} />
...
- **[AI Gateway](cli/aigateway/resources.md)** — Manage workspaces, routing configs, guardrails, providers, credentials, integrations, MCP servers, deployments, plugins, audit logs, and runtime telemetry with SDK-validated commands.
